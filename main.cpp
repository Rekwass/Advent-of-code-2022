...
int main(const int ac, const char* av[])
{
    ...
    void (*functionPointer[8])() = {&calorieCounting, &rockPaperScissors, &rucksackReorganization, &campCleanup, &supplyStacks, &tuningTrouble, &noSpaceLeftOnDevice, &treetopTreeHouse};
